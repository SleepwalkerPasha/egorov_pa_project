...
public class LinkController {
    ...
    @PostMapping("/links")
    public LinkResponse addLinkToFollowing(
        @RequestHeader("Tg-Chat-Id") Long id,
        @RequestBody @Valid AddLinkRequest link
    ) {
    ...
    @DeleteMapping("/links")
    public LinkResponse removeLinkFromFollowing(
        @RequestHeader("Tg-Chat-Id") Long id,
        @RequestBody @Valid RemoveLinkRequest link
    ) {
